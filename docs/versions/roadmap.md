...
| **[version-3-enterprise-ecosystem.md](file:///home/thanhduy/Projects/agent_deck/docs/versions/version-3-enterprise-ecosystem.md)** | **Version 3.0.0** | 🚀 Active & Extensible | Remote LAN/VPN terminal access, Embedded Preview Browser & UI Component Steering, WASM plugins, MCP server bridge |
...
| **FR-PREV-01..04** | Embedded Preview Browser, Dev Server Auto-Detect, Crosshair Inspector & Direct UI Steer | **V3.0** | ✅ Implemented | [V3 Spec](file:///home/thanhduy/Projects/agent_deck/docs/versions/version-3-enterprise-ecosystem.md#31-module-1-embedded-preview-browser--ui-component-steering-preview-browser-implemented) |
| **FR-LAN-01..04** | Remote Access via LAN/VPN (PWA, Axum WS Streaming, QR Code Pairing) | **V3.0** | 🔮 Planned | [V3 Spec](file:///home/thanhduy/Projects/agent_deck/docs/versions/version-3-enterprise-ecosystem.md#32-module-2-remote-access-via-lanvpn-remote-lan) |
...
| **Extended Extensibility** | WASM Plugins, Native MCP Server Bridge, Diagnostic Hooks | **V3.0** | 🔮 Future | [V3 Spec](file:///home/thanhduy/Projects/agent_deck/docs/versions/version-3-enterprise-ecosystem.md) |
