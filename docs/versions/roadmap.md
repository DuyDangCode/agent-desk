...
| **[version-2-multi-agent-power.md](file:///home/thanhduy/Projects/agent_deck/docs/versions/version-2-multi-agent-power.md)** | **Version 2.0.0** | ✅ Implemented & Verified | Horizontal project navigation bar, parallel multi-project workspaces, intra-line diffing, custom prompt templates, AI commit synthesis, split terminal grid |
...
| :--- | :--- | :---: | :---: | :--- |
| **FR-PROJ-01..08** | Multi-Project Bar, Folder Attachment, Parallel Workspaces & Persistence | **V2.0** | ✅ Delivered | [V2 Spec](file:///home/thanhduy/Projects/agent_deck/docs/versions/version-2-multi-agent-power.md#31-module-1-multi-project-management--horizontal-navigation-bar-proj) |
